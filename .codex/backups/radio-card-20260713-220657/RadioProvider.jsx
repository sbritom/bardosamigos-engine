...
const RADIO_STREAM_URL = "https://stm1.mxcast.com.br:7186/stream";
const RADIO_STATS_URL = "http://localhost:3333/engine/radio/mxcast/status";
    ...
    async function loadMetadata() {
      try {
        ...
        setCurrentStation((previous) => ({
          ...
          program: data.online
            ? `${data.listeners || 0} ${(data.listeners || 0) === 1 ? "ouvinte" : "ouvintes"} • ${data.bitrate || 320} kbps`
            : "Transmissão offline",
