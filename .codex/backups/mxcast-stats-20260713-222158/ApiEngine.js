...
async function getMxCastStatus() {
  const statsUrl = "https://stm1.mxcast.com.br:7186/stats?sid=1";
  ...
  if (!response.ok) {
    throw new Error(`MxCast respondeu com HTTP ${response.status}`);
  }
  ...
  return {
    ...
    contentType,
    serverTitle,
    streamUrl: "https://stm1.mxcast.com.br:7186/stream",
