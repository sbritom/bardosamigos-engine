...
export async function getRadioPublicContent() {
  ...
  return {
    ...
    rankingMeta: {
      ...
      songsEvaluated: evoxRanking.songsEvaluated,
      likesCount: evoxRanking.likesCount,
      approvalPercent: evoxRanking.approvalPercent,
      totalReactions: evoxRanking.totalReactions,
      mostLiked: evoxRanking.mostLiked,
      mostFavorited: evoxRanking.mostFavorited,
      mostRejected: evoxRanking.mostRejected,
