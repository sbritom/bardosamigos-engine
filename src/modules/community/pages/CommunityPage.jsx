...
const RULE_CATEGORIES = [
  {
    id: 'convivencia-xat-conteudo',
    title: 'Convivência, Xat e Conteúdo',
    description: 'Regras gerais para convivência, uso da sala e publicações.',
    rules: [
      'Respeite todos os participantes e mantenha uma boa convivência.',
      'Ofensas, ameaças, perseguição, discriminação e exposição de dados pessoais não são permitidas.',
      'Siga os Termos de Serviço do xat.com.',
      'Sem flood, spam, golpes, phishing, links maliciosos ou divulgação não autorizada.',
      ...
      'Conteúdos que violem as regras poderão ser removidos pela equipe.',
    ],
  },
  {
    id: 'games-eventos',
    title: 'Games e Eventos',
    description: 'Regras para participação, resultados e premiações.',
    rules: [
      'Respeite data, horário e regras específicas de cada game ou evento.',
      'Uma conta por participante, quando a atividade exigir participação individual.',
      'Sem scripts, automações, fraude, combinação ou manipulação de resultados.',
      'Bugs ou falhas não podem ser explorados para obter vantagem.',
      'Em caso de erro técnico, a rodada poderá ser anulada ou refeita.',
      'Cada game ou evento pode possuir regras próprias.',
