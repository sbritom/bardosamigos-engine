...
const sidebarSections = [
  {
    ...
    tools: [
      ...
      { id: 'resize', title: 'Redimensionar', icon: Image, available: true },
    ],
  },
  {
    title: 'Cores',
...
const availableTools = sidebarSections.flatMap((section) => section.tools.map((tool) => ({ ...tool, section: section.title })))
const sidebarItems = [
