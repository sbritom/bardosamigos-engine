...
export function FootballCompetitionHero({ config, competition, matches, teamCount, liveCount }) {
  ...
  return (
    <section className="relative isolate overflow-hidden rounded-[var(--bds-radius-md)] border border-[color-mix(in_srgb,var(--bds-color-border)_58%,transparent)] bg-[var(--bds-color-background)] p-[var(--bds-space-24)] shadow-none sm:p-[var(--bds-space-40)]">
      {backgroundImage ? <div className="absolute inset-0 -z-10 bg-cover bg-center opacity-[var(--bds-opacity-muted)]" style={{ backgroundImage: `url("${backgroundImage}")` }} /> : <div className="absolute inset-0 -z-10 bg-[color-mix(in_srgb,var(--bds-color-surface)_34%,transparent)]" />}
      ...
      <div className="relative z-10">
        <div className="flex flex-wrap items-start justify-between gap-[var(--bds-space-24)]">
          <div className="flex min-w-0 items-center gap-[var(--bds-space-24)]">
            <span className="flex h-24 w-24 shrink-0 items-center justify-center rounded-[var(--bds-radius-md)] border border-[color-mix(in_srgb,var(--bds-color-border)_58%,transparent)] bg-[color-mix(in_srgb,var(--bds-color-background)_86%,transparent)] p-[var(--bds-space-16)] shadow-none sm:h-32 sm:w-32">
