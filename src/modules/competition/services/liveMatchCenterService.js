...
export function createLiveMatchCenterHeroModel(match, options = {}) {
  ...
  return {
    ...
    homeTeam: translateCountry(safeMatch.homeTeam || safeMatch.homeParticipant || safeMatch.home_participant || ''),
    awayTeam: translateCountry(safeMatch.awayTeam || safeMatch.awayParticipant || safeMatch.away_participant || ''),
    homeShield: safeMatch.homeShield || '',
    awayShield: safeMatch.awayShield || '',
