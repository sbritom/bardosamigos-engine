    ...
    <Card className="rounded-[var(--radius)] border border-[var(--bds-color-border)] bg-[var(--bds-color-surface)] p-4">
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 text-xs font-black uppercase text-[var(--bds-color-primary-hover)]">
          ...
          <div className="mt-2 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
            ...
            <div className="text-lg font-black text-[var(--bds-color-primary-hover)]">{formatMatchScore(match)}</div>
          ...
          {(match.venue || metadata.venue || match.country || metadata.country) && (
            <p className="mt-1 text-xs font-bold text-[var(--bds-color-text-secondary)]">
      ...
      {match.myPrediction ? (
        <div className="mt-4 rounded-xl border border-[var(--bds-color-border)] bg-[var(--bds-color-background)] p-3">
          <div className="text-xs font-black uppercase text-[var(--bds-color-text-secondary)]">Meu palpite</div>
          <div className="mt-1 text-2xl font-black text-[var(--bds-color-primary-hover)]">{formatScore(match.myPrediction)}</div>
